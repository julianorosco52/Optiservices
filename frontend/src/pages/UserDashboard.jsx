  ...
  useEffect(() => {
    const fetchTickets = async () => {
      try {
        ...
        const res = await axios.get(`http://localhost:5000/api/tickets?page=${page}&limit=10&status=${filterStatus}&search=${searchTerm}`, {
    ...
    socket.on("ticket:deleted", (deletedTicketId) => {
